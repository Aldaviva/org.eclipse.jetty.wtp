...
public class Trace {
	...
	private static final String[] levelNames = new String[] { "CONFIG   ", "PERF     ", "WARNING  ", "SEVERE   ", "FINER    ", "FINEST   " };
	 ...
	 *            a message
	 */
	public static void trace(final byte level, final String s) {
	 ...
	 *            a throwable
	 */
	public static void trace(final byte level, final String s, final Throwable t) {
	 ...
	 *            a throwable
	 */
	private static void trace(final String pluginId, final int level, final String s, final Throwable t) {
		...
		final StringBuilder sb = new StringBuilder(pluginId);
	...
	public static boolean isTraceEnabled() {
		return true; //FIXME don't have tracing always enabled
