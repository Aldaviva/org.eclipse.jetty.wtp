...
public class WebSocketServletTemplate
{
    ...
    protected final String TEXT_88 = NL + NL + "\t/**" + NL + "\t * @see Servlet#init(ServletConfig)" + NL + "\t */" + NL
            + "\tpublic void init(ServletConfig config) throws ServletException {" + NL + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_89 = NL + NL + "\t/**" + NL + "\t * @see Servlet#destroy()" + NL + "\t */" + NL + "\tpublic void destroy() {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_90 = NL + NL + "\t/**" + NL + "\t * @see Servlet#getServletConfig()" + NL + "\t */" + NL
            + "\tpublic ServletConfig getServletConfig() {" + NL + "\t\t// TODO Auto-generated method stub" + NL + "\t\treturn null;" + NL + "\t}";
    protected final String TEXT_91 = NL + NL + "\t/**" + NL + "\t * @see Servlet#getServletInfo()" + NL + "\t */" + NL + "\tpublic String getServletInfo() {"
            + NL + "\t\t// TODO Auto-generated method stub" + NL + "\t\treturn null; " + NL + "\t}";
    protected final String TEXT_92 = NL + NL + "\t/**" + NL + "\t * @see Servlet#service(ServletRequest request, ServletResponse response)" + NL + "\t */" + NL
            + "\tpublic void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_93 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#service(HttpServletRequest request, HttpServletResponse response)" + NL
            + "\t */" + NL + "\tprotected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_94 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doGet(HttpServletRequest request, HttpServletResponse response)" + NL
            + "\t */" + NL + "\tprotected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_95 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doPost(HttpServletRequest request, HttpServletResponse response)" + NL
            + "\t */" + NL + "\tprotected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\tgetServletContext().getNamedDispatcher(\"default\").forward(request, response);" + NL + "\t}" + NL + "\t" + NL + "\t/*" + NL
            + "\t * @see org.eclipse.jetty.websocket.WebSocketServlet#doWebSocketConnect(javax.servlet.http.HttpServletRequest, java.lang.String)" + NL
            + "\t */" + NL + "\tprotected WebSocket doWebSocketConnect(HttpServletRequest request, String protocol) {" + NL + "\t\treturn new ";
    protected final String TEXT_96 = "();" + NL + "\t}" + NL + "\t" + NL + "\tclass ";
    protected final String TEXT_97 = " implements WebSocket {" + NL + "\t\tprivate Outbound outbound;" + NL + "" + NL
            + "\t\tpublic void onConnect(Outbound outbound) {" + NL + "\t\t\tthis.outbound = outbound;" + NL + "\t\t\tmembers.add(this);" + NL + "\t\t}" + NL
            + "" + NL + "\t\t/*" + NL + "\t\t * @see org.eclipse.jetty.websocket.WebSocket#onMessage(byte, byte[]," + NL + "\t\t * int, int)" + NL + "\t\t */"
            + NL + "\t\tpublic void onMessage(byte frame, byte[] data, int offset, int length) {" + NL + "\t\t}" + NL + "" + NL + "\t\t/*" + NL
            + "\t\t * @see org.eclipse.jetty.websocket.WebSocket#onMessage(byte," + NL + "\t\t * java.lang.String)" + NL + "\t\t */" + NL
            + "\t\tpublic void onMessage(byte frame, String data) {" + NL + "\t\t\t";
    protected final String TEXT_98 = NL + "\t\t\tfor (";
    protected final String TEXT_99 = " member : members) {" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tmember.outbound.sendMessage(frame, data);" + NL
            + "\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t// org.eclipse.jetty.util.log.Log.warn(e);" + NL + "\t\t\t\t\te.printStackTrace();" + NL
            + "\t\t\t\t}" + NL + "\t\t\t}";
    ...
    protected final String TEXT_102 = ") iterator.next();" + NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\tmember.outbound.sendMessage(frame, data);" + NL
            + "\t\t\t\t} catch (IOException e) {" + NL + "\t\t\t\t\t// org.eclipse.jetty.util.log.Log.warn(e);" + NL + "\t\t\t\t\te.printStackTrace();" + NL
            + "\t\t\t\t}" + NL + "\t\t\t}";
    protected final String TEXT_103 = NL + "\t\t}" + NL + "" + NL + "\t\t/*" + NL + "\t\t * @see org.eclipse.jetty.websocket.WebSocket#onDisconnect()" + NL
            + "\t\t */" + NL + "\t\tpublic void onDisconnect() {" + NL + "\t\t\tmembers.remove(this);" + NL + "\t\t}" + NL + "\t}" + NL;
    protected final String TEXT_104 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doPut(HttpServletRequest, HttpServletResponse)" + NL + "\t */" + NL
            + "\tprotected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_105 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doDelete(HttpServletRequest, HttpServletResponse)" + NL + "\t */" + NL
            + "\tprotected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_106 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doHead(HttpServletRequest, HttpServletResponse)" + NL + "\t */" + NL
            + "\tprotected void doHead(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_107 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doOptions(HttpServletRequest, HttpServletResponse)" + NL + "\t */" + NL
            + "\tprotected void doOptions(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
    protected final String TEXT_108 = NL + NL + "\t/**" + NL + "\t * @see HttpServlet#doTrace(HttpServletRequest, HttpServletResponse)" + NL + "\t */" + NL
            + "\tprotected void doTrace(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {" + NL
            + "\t\t// TODO Auto-generated method stub" + NL + "\t}";
        ...
        if ("3.0".equals(model.getJavaEEVersion()))
        {
            ...
            else if (!params.isEmpty())
            {
                ...
                boolean needNewLine = keys.contains(CreateWebSocketTemplateModel.ATT_INIT_PARAMS)
                        || (keys.contains(CreateWebSocketTemplateModel.ATT_URL_PATTERNS) && ((List<String[]>)params
                                .get(CreateWebSocketTemplateModel.ATT_URL_PATTERNS)).size() > 1);
                boolean needComma = false;
                for (String key : keys)
                {
                    if (needComma)
